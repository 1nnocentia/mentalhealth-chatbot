...
GOOGLE_API_KEY = os.getenv('mentalhealth-chatbot')
...
def generate_response(prompt):
    try:
        ...
        # Text generate from prompt which temperature (creativity) is 0.7/1 and max_output_tokens is for limit the max text to generate
...
def contains_trigger_words(user_input):
...
if __name__ == "__main__":
    print('Warnings: This chatbot is not a substitute for professional mental health care. To end this chat, please tipe "exit"')
    ...
    while True:
        ...
        if user_input.lower() == "exit":
            ...
            break
        if contains_trigger_words(user_input):
